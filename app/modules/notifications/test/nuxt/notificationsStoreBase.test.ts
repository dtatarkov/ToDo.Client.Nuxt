...
describe('NotificationsStoreBase', () =>
{
    ...
    describe('addNotification', () =>
    {
        ...
        it('should emit onNotificationAdded event', () =>
        {
            const callback = vi.fn();

            store.onNotificationAdded(callback);
    ...
    describe('[Symbol.dispose]', () =>
    {
        ...
        it('should throw DisposedException when getting notifications after disposal', () =>
        {
            store[Symbol.dispose]();
        ...
        it('should throw DisposedException when subscribing to notification changes after disposal', () =>
        {
            store[Symbol.dispose]();

            expect(() =>
            {
                store.onNotificationAdded(() => { });
            }).toThrow(DisposedException);
        });
    });
});
...
export class InputViewmodelDate extends InputViewmodelNuxtUIBase<Date | undefined, InputElementDateProps, InputViewmodelDateData> implements InputViewmodelDateData
{
  ...
  protected override getDataScheme(): DataAdapterFieldsScheme<InputViewmodelDateData, InputElementDateProps>
  {
    return mergeDeep(super.getDataScheme(), <Partial<DataAdapterFieldsScheme<InputViewmodelDateData, InputElementDateProps>>>{
      value: {

...
import { RenderableViewmodel } from '@client/ui-core';
import type { FormDataFull } from '../types/formDataFull';

export abstract class FormViewmodel<TEntity extends Record<string, any> = Record<string, any>> extends RenderableViewmodel<FormDataFull>
{
  static renderKey: symbol = Symbol('form-vm');
